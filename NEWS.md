...
* `scans_app()` launches a read-only Shiny app for filtering trajectories, browsing canonical turns and events, and inspecting linked findings, evaluations, losses, and source context (#2).
