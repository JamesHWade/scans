...
renders the same bundle as a read-only Shiny app: a trajectory list you
can search, filter, and sort; a transcript rendered as chat with tool
activity collapsed into rows; and an evidence rail that links each
finding to the events behind it.
